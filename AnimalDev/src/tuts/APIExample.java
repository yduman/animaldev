...
public class APIExample {
	...
	private static final String DESCRIPTION = "QuickSort w�hlt ein Element aus der zu sortierenden Liste aus "
	...
	public void sort(int[] a) {
		...
		IntArray ia = lang.newIntArray(new Coordinates(20, 100), a, "intArray", null, arrayProps);
	...
	private void quickSort(IntArray array, SourceCode codeSupport, int l, int r) throws LineNotExistsException {
		...
		ArrayMarker iMarker = lang.newArrayMarker(array, 0, "i" + pointerCounter, null, arrayIMProps);
		pointerCounter++;
		...
		ArrayMarker jMarker = lang.newArrayMarker(array, 0, "j" + pointerCounter, null, arrayJMProps);
		...
		ArrayMarker pivotMarker = lang.newArrayMarker(array, 0, "pivot" + pointerCounter, null, arrayPMProps);
	...
	public static void main(String[] args) {
		...
		Language l = Language.getLanguageInstance(AnimationType.ANIMALSCRIPT, "Quicksort Example", "Guido R��ling", 640,
				480);
